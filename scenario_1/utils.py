...
def get_simple_data_loader():
    ...
    train_ls = [train_acc_meter, train_grav, train_gyro, train_jin_acc, train_jin_gyro, train_lin_acc, train_mag_meter, train_ms_acc, train_ms_gyro]
...
def get_simple_eval_loader():
    ...
    # concat all training Tensors:
    eval_ls = [eval_acc_meter, eval_grav, eval_gyro, eval_jin_acc, eval_jin_gyro, eval_lin_acc, eval_mag_meter, eval_ms_acc, eval_ms_gyro]
